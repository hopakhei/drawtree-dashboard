...
const zh = {
  ...
  home: {
    ...
    protocolLede: "把一個論點寫成可被證偽的樹，而不是說說而已。",
    protocolBody:
      "將 Drawtree 的 MCP 伺服器接上 Perplexity、Claude Desktop 或任何 Remote-MCP 主機，共同設計可證偽的樹：每項主張都有證偽條件，每個判定都經簽署、加上時間戳，並每週重新核對。",
    protocolCta: "免費註冊",
